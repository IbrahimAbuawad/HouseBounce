      ...
      <CardContent>
        ...
        <div class="status">
          ...
          {item.reqStatus === "pending" && 
            <Typography variant="body2" style={{color:'#1d4db7',fontWeight:'bold'}} component="span">
              {`Status : ${item.reqStatus} `}
            </Typography>
          }
           {item.reqStatus === "rejected" && 
            <Typography variant="body2" style={{color:'#d60000',fontWeight:'bold'}} component="span">
              {`Status : ${item.reqStatus} `}
            </Typography>
          }
           {item.reqStatus === "approved" && 
            <Typography variant="body2" style={{color:'#16b103',fontWeight:'bold'}} component="span">
              {`Status : ${item.reqStatus} `}
            </Typography>
          }
        </div>
